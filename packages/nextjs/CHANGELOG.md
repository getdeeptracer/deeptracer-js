...
- fa27ff4: feat(nextjs): add `ignore` option to filter source map uploads
  ...
  **Custom patterns:**
  ...
  - @deeptracer/core@0.8.3
  - @deeptracer/node@0.8.3
  - @deeptracer/react@0.8.3
...
- fc0c4d0: fix: source map upload now fast-fails on first error; browser transport uses keepalive for reliable delivery on page unload
...
- Updated dependencies [fc0c4d0]
  - @deeptracer/core@0.8.1
  - @deeptracer/node@0.8.1
  - @deeptracer/react@0.8.1
...
- Updated dependencies [cc365a5]
  ...
  - @deeptracer/node@0.8.0
  - @deeptracer/react@0.8.0
...
- 374afbe: Fix TypeError crash when route handlers clone a Request object
...
- Updated dependencies [15d3da3]
  ...
  - @deeptracer/node@0.7.0
  - @deeptracer/react@0.7.0

## 0.6.4

### Patch Changes

- 9c7e0e2: Fix TypeError crash when route handlers clone a Request object
  ...
  - @deeptracer/node@0.6.4
  - @deeptracer/react@0.6.4
...
- Updated dependencies [e667a19]
  ...
  - @deeptracer/node@0.6.3
  - @deeptracer/react@0.6.3
